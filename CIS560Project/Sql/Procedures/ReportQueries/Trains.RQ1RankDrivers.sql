...
SELECT T.Driver, 
	...
	SUM( CAST(R.Distance * T.BaseSpeed) / CAST(DATEDIFF(MI, R.ArrivalTime, R.DepartureTime) AS INT)) / COUNT(DISTINCT R.RouteID) AS AverageTimeInMinutes,
	RANK() OVER (
